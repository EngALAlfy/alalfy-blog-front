                ...
                <div className="top-row d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="social-links">
                            <a href="https://www.facebook.com/EngineerMix" className="facebook"><i
                                className="bi bi-facebook"></i></a>
                            <a href="https://api.whatsapp.com/send?phone=201153263994" className="whatsapp"><i
                                className="bi bi-whatsapp"></i></a>
                            <a href="https://www.instagram.com/yotech_org/" className="instagram"><i
                                className="bi bi-instagram"></i></a>
                            <a href="https://www.linkedin.com/in/islam-hassan-alalfy-2b2234167" className="linkedin"><i
                                className="bi bi-linkedin"></i></a>
                            <a href="https://github.com/EngALAlfy" className="github"><i
            ...
            <div className="nav-wrap">
                <div className="container d-flex justify-content-center position-relative">
                    <nav id="navmenu" className="navmenu">
                        <ul>
                            {strings.layout.header.navItems.map((item, index) => (
                                <li key={`header-${index}-${item.path}`}>
